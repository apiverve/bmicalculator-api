...
namespace APIVerve\Bmicalculator;
...
/**
 * Client for the BMI Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/bmicalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bmicalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BmicalculatorClient] {$message}\n";
        }
    }
}
