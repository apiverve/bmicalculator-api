...
// Request contains the parameters for the BMI Calculator API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"weight": {Type: "number", Required: true, Min: float64Ptr(1)},
		"height": {Type: "number", Required: true, Min: float64Ptr(1)},
...
// ResponseData contains the data returned by the BMI Calculator API.
