...
namespace APIVerve.API.BMICalculator
{
    ...
    /// <summary>
    /// Client for the BMICalculator API
    /// </summary>
    public class BMICalculatorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/bmicalculator";
        ...
        {
            { "weight", new ValidationRule { Type = "number", Required = true, Min = 1 } },
            { "height", new ValidationRule { Type = "number", Required = true, Min = 1 } },
            { "unit", new ValidationRule { Type = "string", Required = true } },
            { "age", new ValidationRule { Type = "number", Required = false, Min = 1, Max = 120 } },
            { "gender", new ValidationRule { Type = "string", Required = false } },
            { "activityLevel", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public BMICalculatorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BMICalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BMICalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BMICalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BMICalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(BMICalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BMICalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BMICalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BMICalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BMICalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BMICalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BMICalculatorQueryOptions options)
        {
