...
```gradle
dependencies {
    implementation 'com.github.apiverve:bmicalculator-api:1.1.14'
}
```
...
```java
import com.apiverve.bmicalculator.BMICalculatorAPIClient;
import com.apiverve.bmicalculator.APIResponse;
import com.apiverve.bmicalculator.APIException;

// Initialize the client
BMICalculatorAPIClient client = new BMICalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("weight", 70);
    parameters.put("height", 170);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bmicalculator](https://docs.apiverve.com/ref/bmicalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/bmicalculator](https://docs.apiverve.com/ref/bmicalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bmicalculator-api/issues)
