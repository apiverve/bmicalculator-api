# BMI Calculator API - Examples

This folder contains example code for using the BMI Calculator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/bmicalculator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/bmicalculator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/bmicalculator](https://docs.apiverve.com/ref/bmicalculator)
